...
public class StepFragmentSample5 extends ButterKnifeFragment implements Step {
...
//    Button button;
    ...
    public static StepFragmentSample5 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragmentSample5 fragment = new StepFragmentSample5();
