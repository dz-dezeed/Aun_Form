...
public class StepFragmentSample4 extends ButterKnifeFragment implements Step {
...
//    Button button;
    ...
    public static StepFragmentSample4 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragmentSample4 fragment = new StepFragmentSample4();
