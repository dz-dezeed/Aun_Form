...
public class StepFragmentSample3 extends ButterKnifeFragment implements Step {
...
//    Button button;
    ...
    public static StepFragmentSample3 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragmentSample3 fragment = new StepFragmentSample3();
