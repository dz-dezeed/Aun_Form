...
public class StepFragmentSample6 extends ButterKnifeFragment implements Step {
...
//    Button button;
    ...
    public static StepFragmentSample6 newInstance(@LayoutRes int layoutResId) {
        Bundle args = new Bundle();
        args.putInt(LAYOUT_RESOURCE_ID_ARG_KEY, layoutResId);
        StepFragmentSample6 fragment = new StepFragmentSample6();
